(define generic-on-key '("zenkaku-hankaku" "<Shift> " "Private2"))
(define generic-on-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "Private2")))
(define generic-off-key '("zenkaku-hankaku" "<Shift> " "Private1"))
(define generic-off-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "Private1")))
